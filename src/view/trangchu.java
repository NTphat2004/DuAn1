...
public class trangchu extends JFrame {
    ...
    public trangchu() {
        ...
        lblNewLabel_3.setIcon(new ImageIcon("src/icon/icons8-x-25.png"));
        ...
        lblNewLabel_4.setIcon(new ImageIcon("src/icon/icons8-x-25.png"));
        ...
        lblNewLabel.setIcon(new ImageIcon("src/icon/icons8-home-36.png"));
        ...
        lblAccount.setIcon(new ImageIcon("src/icon/icons8-account-36.png"));
        ...
        lblNhnVin.setIcon(new ImageIcon("src/icon/icons8-conference-36.png"));
        ...
        lblThngK.setIcon(new ImageIcon("src/icon/icons8-analytics-36.png"));
        ...
        lblSnPhm.setIcon(new ImageIcon("src/icon/icons8-object-36.png"));
        ...
        lblNewLabel_1.setIcon(new ImageIcon("src/icon/icons8-account-45.png"));
        ...
        lblSnPhm_1.setIcon(new ImageIcon("src/icon/icons8-warehouse-36.png"));
        ...
        lblHan.setIcon(new ImageIcon("src/icon/icons8-bill-36.png"));
        ...
        lblKhchHng.setIcon(new ImageIcon("src/icon/icons8-user-3611.png"));
        ...
        lblLchLmVic.setIcon(new ImageIcon("src/icon/icons8-schedule-36.png"));
        ...
        lblThot.setIcon(new ImageIcon("src/icon/icons8-earth-36.png"));
        ...
        lblLchLmVic_2.setIcon(new ImageIcon("src/icon/icons8-log-out-3612.png"));
        ...
        lblLchLmVic_1.setIcon(new ImageIcon("src/icon/icons8-log-out-36.png"));
        ...
        lblNewLabel_2.setIcon(new ImageIcon("src/icon/icons8-list-42.png"));
...
//		});
        ...
        lblNewLabel_16.setIcon(new ImageIcon("src/icon/icons8-x-25.png"));
        ...
        lblNewLabel_14.setIcon(new ImageIcon("src/icon/EXP.png"));
        ...
        lblNewLabel_2_1.setIcon(new ImageIcon("src/icon/icons8-x-25.png"));
        ...
        lblNewLabel_2_2.setIcon(new ImageIcon("src/icon/icons8-setting-42.png"));
        ...
        lblNewLabel_11.setIcon(new ImageIcon("src/icon/icons8-x-25.png"));
        ...
        lblNewLabel_12.setIcon(new ImageIcon("src/icon/icons8-dark-36.png"));
        ...
        lblNewLabel_12_1.setIcon(new ImageIcon("src/icon/icons8-light-36.png"));
        ...
        lblNewLabel_12_1_1.setIcon(new ImageIcon("src/icon/icons8-calculator-36.png"));
        ...
        lblNewLabel_5.setIcon(new ImageIcon("src/icon/logo-cua-hang-tien-loi-8-removebg-preview.png"));
        ...
        try {
            if (Auth.user.getGioiTinh() == "nam") {
                ...
                lblNewLabel_1.setIcon(new ImageIcon("src/icon/icons8-female-user-45.png"));
            }
