...
public class Login extends JDialog {
    ...
    public Login(java.awt.Frame parent, boolean modal) {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                NhanVien taikhoanfind = new NhanVien();
                ...
                if (!textField.getText().equals("") && !String.valueOf(passwordField.getPassword()).equals("")) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, taikhoanfind);
        ...
        lblNewLabel_4_1.setBounds(44, 270, 295, 14);
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Login frame = new Login(new javax.swing.JFrame(), true);
